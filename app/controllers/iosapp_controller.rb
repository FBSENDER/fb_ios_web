...
class IosappController < ApplicationController
  ...
  $ios_app_ids = %(1519578790 1517830498 1516808404 1522189191 1216210315 1528520200)
  ...
  def user_login
    ...
    if user
      ...
      guide = 0 if params[:app_id] == "1516808404" && params[:version] == "1.2" #yongyi in review
      guide = 0 if params[:app_id] == "1528520200" && params[:version] == "1.0" #fangzhou in review
